...
import { X, Send, AlertCircle, CheckCircle2, MessageSquare, Bug, Lightbulb, FileText } from 'lucide-react';
...
export default function FeedbackModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[1100] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md animate-fade-in">
      <div className="w-full max-w-md bg-white border-4 border-indigo-500 rounded-3xl p-6 shadow-2xl space-y-5 relative overflow-hidden max-h-[90vh] overflow-y-auto animate-pop flex flex-col">
        ...
        {success ? (
            <div className="flex flex-col items-center justify-center text-center py-8 space-y-4 animate-pop">
                ...
                <p className="text-sm text-slate-600 font-medium max-w-xs">
                    Your feedback helps us make Kibo Climb better for everyone.
                </p>
            </div>
        ) : (
            <>
