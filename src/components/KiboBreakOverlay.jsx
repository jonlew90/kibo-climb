  ...
  return (
    <div className="fixed inset-0 z-[999] h-[100dvh] max-h-[100dvh] bg-gradient-to-b from-amber-50 via-sky-50 to-teal-50 text-slate-800 flex flex-col justify-between p-3 sm:p-4 overflow-hidden select-none animate-pop">
      ...
      <div className="w-full max-w-sm sm:max-w-md mx-auto h-full flex flex-col justify-between relative z-10 text-center py-1">
        {/* SCROLLABLE / SCALABLE TOP & MIDDLE CONTENT AREA */}
        <div className="flex-1 min-h-0 overflow-y-auto space-y-2.5 py-1 px-1 flex flex-col justify-center items-center">
          {/* Banner Header */}
          ...
          <div className="w-full grid grid-cols-2 gap-1.5 bg-white/95 border-2 border-amber-200/90 rounded-2xl p-2.5 backdrop-blur-md shadow-md text-left shrink-0">
            {/* Accuracy Tile */}
          ...
          <div className="w-full bg-gradient-to-r from-amber-100 via-yellow-100 to-purple-100 border border-amber-300 rounded-2xl p-2 px-3 flex items-center justify-between shadow-xs shrink-0">
        ...
        <div className="space-y-2 shrink-0 pt-2 pb-1 w-full bg-amber-50/90 border-t border-amber-200/60 z-20">
          <button
            type="button"
