...
export default function KiboBreakOverlay({
  ...
  return (
    <div className="fixed inset-0 z-[999] h-[100dvh] max-h-[100dvh] bg-gradient-to-b from-amber-50 via-sky-50 to-teal-50 text-slate-800 flex flex-col justify-between p-3 sm:p-4 overflow-hidden select-none animate-pop">
      ...
      <div className="w-full max-w-sm sm:max-w-md mx-auto h-full flex flex-col justify-between relative z-10 text-center py-0.5">
        {/* Banner Header */}
        ...
        {/* Dynamically Scalable Mascot Stage */}
        <div className="relative flex justify-center items-center shrink min-h-0 my-1 max-h-[22vh]">
          <div className="absolute w-24 h-24 rounded-full bg-amber-400/25 blur-xl animate-pulse pointer-events-none" />
          <Mascot
            mood="happy"
            state="break"
            equipped={equippedItems}
            className="h-full max-h-[18vh] min-h-[50px] w-auto filter drop-shadow-md animate-bounce object-contain"
          />
        </div>

        {/* 4-Tile Detailed Climb Stats Matrix */}
        <div className="grid grid-cols-2 gap-1.5 bg-white/95 border-2 border-amber-200/90 rounded-2xl p-2 backdrop-blur-md shadow-md text-left shrink-0">
          {/* Accuracy Tile */}
          <div className="bg-emerald-50/80 border border-emerald-200/80 rounded-xl p-1.5 space-y-0.5">
            ...
            <div className="flex items-baseline justify-between">
              <span className="text-sm sm:text-base font-black text-emerald-700">{correctCount} / {totalCount}</span>
          ...
          <div className="bg-amber-50/80 border border-amber-200/80 rounded-xl p-1.5 space-y-0.5">
            ...
            <div className="text-sm sm:text-base font-black text-amber-700 flex items-center gap-1">
              +{sparksEarned} ⚡
            </div>
          </div>
          ...
          <div className="bg-cyan-50/80 border border-cyan-200/80 rounded-xl p-1.5 space-y-0.5">
            ...
            <div className="text-sm sm:text-base font-black text-cyan-700">
        ...
        <div className="bg-gradient-to-r from-amber-100 via-yellow-100 to-purple-100 border border-amber-300 rounded-2xl p-1.5 px-3 flex items-center justify-between shadow-xs shrink-0">
          <span className="text-[10px] sm:text-xs font-black text-purple-900 flex items-center gap-1 uppercase">
