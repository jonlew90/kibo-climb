...
export default function KiboBreakOverlay({
  ...
  return (
    <div className="fixed inset-0 z-[999] bg-gradient-to-b from-amber-50 via-sky-50 to-teal-50 text-slate-800 flex flex-col items-center justify-start p-3 sm:p-5 overflow-y-auto select-none animate-pop">
      <ConfettiCanvas />

      <div className="w-full max-w-sm sm:max-w-md mx-auto my-auto space-y-3 relative z-10 text-center py-2">
        {/* Banner Header */}
