...
import PetGraphic, { PET_CONFIGS } from './PetGraphic';
    ...
    >
      ...
      >
        <defs>
          ...
          {/* Companion Pet Dedicated Gradients */}
        ...
        {/* ==================================================== */}
        {/* LAYER 5: HIGH-FIDELITY COMPANION PETS (In Front)    */}
        {/* ==================================================== */}
        {equippedPetId && (
          <g transform={PET_CONFIGS[equippedPetId]?.type === 'ground' ? "translate(144, 98) scale(0.68)" : "translate(148, 22) scale(0.68)"}>
            <PetGraphic petId={equippedPetId} isCompanion={true} />
          </g>
        )}
      </svg>
    </div>
