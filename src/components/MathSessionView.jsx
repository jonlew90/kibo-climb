            ...
            return (
              ...
              >
                ...
                <div className="w-full flex flex-wrap items-center justify-center gap-1.5 py-0.5">
                  ...
                  {storageService?.hasClubMembership?.(profileId) ? (
                    <span
                      className="text-xs font-black uppercase text-amber-950 bg-gradient-to-r from-amber-200 via-yellow-200 to-amber-300 px-2.5 py-1 sm:px-3 sm:py-1 rounded-full border border-amber-400 shrink-0 shadow-2xs flex items-center gap-1.5"
                    ...
                    <span
                      className="text-xs font-bold text-amber-800 bg-amber-50 px-2.5 py-1 sm:px-3 sm:py-1 rounded-full border border-amber-200 shrink-0 shadow-2xs flex items-center gap-1"
