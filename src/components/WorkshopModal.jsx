            ...
            {viewMode === 'shop' && activeHub === 'sparks' ? (
              <div className="space-y-3 max-w-3xl mx-auto pb-24 sm:pb-16">
                ...
                {(() => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-gradient-to-r from-purple-600 via-indigo-600 to-violet-700 border border-indigo-400/40 text-white rounded-2xl p-3.5 sm:p-4 shadow-md hover:border-amber-300/60 transition-colors cursor-pointer relative overflow-hidden group"
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 relative z-10">
                        ...
                        <div className="shrink-0">
                          <button
                            type="button"
                            className="w-full sm:w-auto bg-white/20 hover:bg-white/30 text-white border border-white/30 font-bold text-xs px-3.5 py-2 rounded-xl flex items-center justify-center gap-1 transition-all shadow-xs"
                          >
                        ...
                        >
                          ...
                          <div className="flex items-center shrink-0">
                            <button
                              type="button"
                              onClick={() => {
                                const targetPack = isMember && clubPrice
                              ...
                              className={`font-bold text-xs px-2.5 py-1.5 rounded-lg shadow-2xs whitespace-nowrap active:scale-95 transition-all flex items-center gap-1.5 cursor-pointer ${
                                isMember
                            ...
                            >
                              {!allowRealMoneyPurchases && (
                                <Lock className={`w-3 h-3 shrink-0 ${isMember ? 'text-amber-100' : 'text-indigo-200'}`} />
                              )}
                              <span>{displayPrice}</span>
                              {isMember && pack.realMoneyPrice && clubPrice ? (
                                <span className="text-[10px] text-amber-100/70 line-through font-semibold">
                                  {pack.realMoneyPrice}
                                </span>
                              ) : !isMember && pack.clubRealMoneyPrice ? (
                                <span className="text-[10px] font-semibold text-indigo-200 bg-indigo-700/60 border border-indigo-500/40 px-1 py-0.2 rounded flex items-center gap-0.5">
                                  <Sparkles className="w-2.5 h-2.5 text-amber-300 fill-amber-300" />
                                  <span>Club: {pack.clubRealMoneyPrice}</span>
                                </span>
                              ) : null}
                            </button>
                          </div>
                ...
                <div
                  ...
                  className="relative overflow-hidden bg-gradient-to-r from-violet-500/10 via-fuchsia-500/10 to-amber-500/10 hover:from-violet-500/15 hover:via-fuchsia-500/15 hover:to-amber-500/15 border-2 border-dashed border-violet-400/60 hover:border-violet-500 rounded-xl p-2.5 sm:p-3 flex items-center justify-between gap-2.5 shadow-xs hover:shadow-md cursor-pointer transition-all text-left group"
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500 to-indigo-600 text-white shadow-xs flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                      <Ticket className="w-4 h-4 stroke-[2.5]" />
                    </div>
                    <div className="min-w-0">
                      <h4 className="text-xs font-black text-violet-950 flex items-center gap-1.5 truncate">
                        <span>Have a Promo Code?</span>
                        <span className="text-[10px] font-bold bg-violet-100 text-violet-700 px-1.5 py-0.2 rounded-full uppercase tracking-wider">Redeem</span>
                      </h4>
                      <p className="text-[11px] text-violet-700/80 font-medium leading-snug">
                  ...
                  <button
                    type="button"
                    className="shrink-0 px-3 py-1.5 bg-violet-600 group-hover:bg-violet-700 text-white font-bold text-xs rounded-lg shadow-xs group-hover:shadow transition-all pointer-events-none active:scale-95"
                  >
                    Enter Code
                  </button>
                </div>
