...
export const DOMAIN_DEFINITIONS = [
  ...
  {
    id: 'money_decimals',
    name: 'Money Decimals & Change',
    icon: '🪙',
    subtitle: '$1.00 Bridge & Change under $1.00',
  ...
  {
    id: 'division_ladder',
    name: 'Division & Long Division',
    icon: '⛰️',
    subtitle: 'Division Fact Families & Halving Ladder',
  ...
  },
  {
    ...
    icon: '🧩',
    subtitle: 'Equivalent Fractions, % & GCF/LCM',
  ...
  {
    id: 'peak_algebra',
    name: 'Exponents, Roots & Pre-Algebra',
    icon: '🏔️',
    subtitle: 'Powers (2⁴), Square Roots & PEMDAS',
